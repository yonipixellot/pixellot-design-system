/*
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║           PIXELLOT DESIGN SYSTEM — React 18 + TypeScript        ║
 * ║                     Single-File Architecture                    ║
 * ╚══════════════════════════════════════════════════════════════════╝
 *
 * ZONE 1 — FOUNDATIONS      Imports, LIGHT/DARK color tokens, typography,
 *                           spacing (T), font (F), SVG paths, helpers
 *
 * ZONE 2 — PRIMITIVES       All P-prefixed React preview components,
 *                           with category markers: Ctrl+F "── "
 *
 * ZONE 3 — VUE DOCS         Vue 3 SFC code examples (C.xxx strings)
 *                           for frontend team reference
 *
 * ZONE 4 — SHOWCASE APP     Nav menu, theme toggle, search, section
 *                           renderer, interactive demos
 *
 * ZONE 5 — MOUNT            ThemeCtx provider, createRoot, DOM mount
 *
 * Navigation: Ctrl+F → "ZONE 1" "ZONE 2" "ZONE 3" "ZONE 4" "ZONE 5"
 *             Ctrl+F → "── " to jump between component categories
 */

/* ═══════════════════════════════════════════════════════════════════
   ZONE 1 — FOUNDATIONS
   Imports · Color tokens (LIGHT/DARK) · Typography & spacing (T)
   Font family (F) · Defaults · SVG paths · Utility helpers
   ═══════════════════════════════════════════════════════════════════ */
...
/* ═══════════════════════════════════════════════════════════════════
   ZONE 2 — PRIMITIVES
   All runtime React components — with category markers throughout.
   Ctrl+F "── " to jump between categories.
   ═══════════════════════════════════════════════════════════════════ */
...
function TeamPage({
  ...
  return (
    <div style={{ width: 390, fontFamily: F, background: "linear-gradient(180deg,#fff 0%,#efefef 25%,rgba(223,223,223,0.7) 50%,#efefef 75%,#fff 100%)", overflowX: "hidden" }}>
      ...
      {/* ── Back ── */}
      <div style={{ display: "flex", alignItems: "center", padding: "24px 16px 0" }}>
      ...
      <div style={{ padding: "24px 16px 0" }}>
        <div style={{ background: c.cardBg, borderRadius: T.radii.badge, padding: `${T.spacing.xl}px ${T.spacing.lg}px`, display: "flex", flexDirection: "column", gap: T.spacing.lg }}>
          <div style={{ display: "flex", gap: T.spacing.lg, alignItems: "center" }}>
            {/* Team Logo — reuses PTeamLogo primitive */}
            <div style={{ width: 120, height: 120, borderRadius: "50%", background: c.white, border: `${T.strokes.medium}px solid ${c.gray100}`, overflow: "hidden", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <PTeamLogo size={80} name={teamName.replace("\n", " ")} logoUrl={logoUrl} />
            </div>
            {/* Team Info */}
...
/* ═══════════════════════════════════════════════════════════════════
   ZONE 3 — VUE DOCUMENTATION
   Vue 3 SFC code examples (C.xxx template strings).
...
/* ═══════════════════════════════════════════════════════════════════
   ZONE 4 — SHOWCASE APP
   Navigation · Theme toggle · Search · Section renderer · Demos
   ═══════════════════════════════════════════════════════════════════ */
